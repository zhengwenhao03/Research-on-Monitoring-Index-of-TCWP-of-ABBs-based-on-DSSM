...
counter = 0;
for probability_generating_middle_vehicle = x_axis
    probability_generating_small_vehicle = (1-probability_generating_middle_vehicle)*6/7;
    counter = counter + 1;
...
xlabel('propotion of mid-sized vehicles')
ylabel('Index')
set(gca,'fontsize',13)