...
counter = 0;
for probability_generating_small_vehicle = x_axis
    probability_generating_middle_vehicle = (1-probability_generating_small_vehicle)*0.75;
    counter = counter + 1;
...
xlabel('propotion of small vehicles')
ylabel('Index')
set(gca,'fontsize',13)