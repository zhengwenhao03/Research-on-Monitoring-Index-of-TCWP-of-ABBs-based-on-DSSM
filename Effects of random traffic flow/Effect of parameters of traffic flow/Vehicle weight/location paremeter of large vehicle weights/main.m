...
counter = 0;
for large_vehicle_mass_location_parameter = x_axis
    counter = counter + 1;
...
legend('DSSM_{12}','DSSM_{23}','DSSM_{34}','DSSM_{45}','Location','northeast')
xlabel('location parameter of large vehicle weights (t)')
ylabel('Index')
set(gca,'fontsize',13)